...
public class BlockDataImportInvisible extends Block {
  ...
  public BlockDataImportInvisible(Port portIn, Port portSuccess, Port portError) {
    super();
    this.portIn = portIn;
  ...
  public BlockDataImportInvisible() {
    super();
  ...
  public BlockDataImportInvisible(int anFlowId, int id, int subflowblockid, String filename) {
