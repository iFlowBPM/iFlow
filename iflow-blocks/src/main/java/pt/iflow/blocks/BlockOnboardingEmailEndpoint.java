...
public class BlockOnboardingEmailEndpoint extends Block {
    ...
    public BlockOnboardingEmailEndpoint (int anFlowId, int id, int subflowblockid, String subflow) {
    ...
    public Port after(UserInfoInterface userInfo, ProcessData procData) {
        ...
        try {
            ...
            sData = procData.transform(userInfo, this.getAttribute(data));
        ...
        if (StringUtilities.isEmpty(sData) || StringUtilities.isEmpty(sOutput)|| StringUtilities.isEmpty(sApiSettingsID) ) {
            ...
            try {
                ...
                jsonObject.addProperty("data", sData);


                Client client = Client.create();
                WebResource webResource = client.resource(BACKEND_URL+"/api/open/onboarding/send_emailEndpoint/"+sApiSettingsID);
