...
public class BlockP17040ImportCERAEntRelOn extends BlockP17040ImportCERA {
	
	public BlockP17040ImportCERAEntRelOn(int anFlowId, int id, int subflowblockid, String filename) {
