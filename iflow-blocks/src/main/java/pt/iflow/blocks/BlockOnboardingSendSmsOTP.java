...
public class BlockOnboardingSendSmsOTP extends Block {
    ...
    public BlockOnboardingSendSmsOTP (int anFlowId, int id, int subflowblockid, String subflow) {
    ...
    public Port after(UserInfoInterface userInfo, ProcessData procData) {
        ...
        try {
            ...
            sPhone = procData.transform(userInfo, this.getAttribute(phone));
            sMessage = procData.transform(userInfo, this.getAttribute(message));
        ...
        if (StringUtilities.isEmpty(sApiSettingsID) || StringUtilities.isEmpty(sPhone)|| StringUtilities.isEmpty(sMessage) ) {
            ...
            try {
                ...
                jsonObject.addProperty("message", sMessage);
                ...
                WebResource webResource = client.resource(BACKEND_URL+"/api/open/onboarding/send_smsOTP/"+sApiSettingsID);
