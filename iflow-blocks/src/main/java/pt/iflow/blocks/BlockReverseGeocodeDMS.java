...
public class BlockReverseGeocodeDMS extends Block {
	public Port portIn, portSuccess, portEmpty, portError;
	
	private static final String INPUT_LATITUDE_DMS = "inputLatitudeDMS";
	private static final String INPUT_LONGITUDE_DMS = "inputLongitudeDMS";
	private static final String OUTPUT_MORADAS = "outputMoradas";	

	public BlockReverseGeocodeDMS(int anFlowId, int id, int subflowblockid, String filename) {
	...
	public Port after(UserInfoInterface userInfo, ProcessData procData) {
		...
		String sInputLatitudeDMSVar = this.getAttribute(INPUT_LATITUDE_DMS);
		String sInputLongitudeDMSVar = this.getAttribute(INPUT_LONGITUDE_DMS);
		String sOutputMoradasVar = this.getAttribute(OUTPUT_MORADAS);

		if (StringUtilities.isEmpty(sInputLatitudeDMSVar) || StringUtilities.isEmpty(sInputLongitudeDMSVar)
		...
		try {
			String valorLatitudeDMS = procData.transform(userInfo, sInputLatitudeDMSVar);
			String valorLongitudeDMS = procData.transform(userInfo, sInputLongitudeDMSVar);
			...
			json = json.put("latDegrees", StringEscapeUtils.unescapeHtml(valorLatitudeDMS));
			json = json.put("lngDegrees", StringEscapeUtils.unescapeHtml(valorLongitudeDMS));
