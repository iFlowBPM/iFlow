 ...
 *  Project FLOW EDITOR
 *
 *  class: AlteraAtributosSQLTemplate
 *
 *  desc: dialogo para alterar atributos de um bloco SQL
 *
 ****************************************************/
...
public class AlteraAtributosSQLTemplate extends AlteraAtributos {
  ...
  public AlteraAtributosSQLTemplate(FlowEditorAdapter adapter) {
    super(adapter);
    initJNDIComboBox();
  }
