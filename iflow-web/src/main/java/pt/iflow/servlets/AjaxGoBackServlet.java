...
public class AjaxGoBackServlet
extends HttpServlet
{
  ...
  throws ServletException, IOException
{
  ...
  try
  {
    flowid = Integer.valueOf(Integer.parseInt(request.getParameter("flowid")));
    pid = Integer.valueOf(Integer.parseInt(request.getParameter("pid")));
    subpid = Integer.valueOf(Integer.parseInt(request.getParameter("subpid")));
    _button_clicked_id = Integer.valueOf(Integer.parseInt(request.getParameter("_button_clicked_id")));
  }
  catch (Exception e)
  {
    return;
  ...
  try
  {
    String formXml = ir.generateXmlForm(userInfo.getUserData().getUsername(), userInfo.getPasswordString(), flowid.intValue(), pid.intValue(), subpid.intValue());
    ir.processXmlForm(userInfo.getUserData().getUsername(), userInfo.getPasswordString(), flowid.intValue(), pid.intValue(), subpid.intValue(), formXml, "" + _button_clicked_id, null);
  }
  catch (Exception e)
  {
    e.printStackTrace();
