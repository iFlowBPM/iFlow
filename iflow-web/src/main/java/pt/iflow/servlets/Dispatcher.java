...
public class Dispatcher extends HttpServlet {
	...
	private UserInfoInterface doLogin(HttpServletRequest request, HttpServletResponse response, String login,
			String password) {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			// logMsg(userInfo, "Username: "+login+" Password: "+password+" OP: "+op+"
			// value: "+value);
	...
	// void funcion (UserInfoInterface userInfo, HttpServletResponse response,
	// Repository rep, String name, String desc, byte[]
	...
	void listProfiles(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
	...
	void listExtraProperties(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listStyleSheets(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listEmailTemplates(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listPrintTemplates(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listFlows(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void listSubFlows(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listLibraries(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listWebServices(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listProcessTaskAnnotationLabels(UserInfoInterface userInfo, HttpServletResponse response, Repository rep,
			String name, String desc, byte[] buffer, String comment) throws Exception {
	...
	void getFlow(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void getWebservice(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getEvent(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void getIcon(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void getClass(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void getFlowState(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		int flowid = -1;
		String pnumber = null;
		try {
		...
		List<FlowStateHistoryTO> flowStateHistory = BeanFactory.getProcessManagerBean().getFullProcessHistory(userInfo,
				flowid, pnumber);
	...
	void getFlowStateLogs(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		...
		List<FlowStateLogTO> flowStateLog = BeanFactory.getProcessManagerBean().getFlowStateLogs(userInfo, flowid,
				pnumber, subpid, state);
	...
	private int convertToNumber(UserInfoInterface userInfo, String[] number, int index) {
		...
		try {
			...
			Logger.error(userInfo.getUtilizador(), this, "convertToNumber",
					"Unable to convert to number (value=" + number[index] + ")", ex);
		} catch (IndexOutOfBoundsException ex) {
			Logger.error(userInfo.getUtilizador(), this, "convertToNumber",
					"Supplied index larger than given array (index=" + index + "; array length=" + number.length + ")",
					ex);
		}
		return ret;
	}
	...
	void setFlow(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
	...
	void setWebService(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		if (null == name || null == desc || null == buffer || buffer.length == 0)
			return; // sacana do editor
	...
	void hasExtendedAPI(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getFlowInfo(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
		...
		if (null != flowData) {
			...
			FlowInfo finfo = new FlowInfo(flowData.getId(), flowData.getName(), flowData.getFileName(),
					flowData.isOnline(), created, modif, flowData.getMaxBlockId());
	...
	void listFlowsExtended(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		...
		for (IFlowData flowData : data) {
			...
			String modif = DateUtility.formatTimestamp(userInfo, new Date(flowData.getLastModified()));
			FlowInfo finfo = new FlowInfo(flowData.getId(), flowData.getName(), flowData.getFileName(),
					flowData.isOnline(), created, modif);
			flows.add(finfo);
		}
	...
	void getZippedIcons(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getZippedLibraries(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getZippedClasses(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		logMsg(userInfo, "getZippedClasses Not Implemented");
	}

	@RepositoryWebOp(code = RepositoryWebOpCodes.GET_LAST_MODIFIED_ICONS)
	void getLastModifiedIcons(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		RepositoryFile[] files = rep.listIcons(userInfo);
		long lmod = 0L;
	...
	void getLastModifiedLibraries(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		RepositoryFile[] files = rep.listLibraries(userInfo);
		long lmod = 0L;
		for (RepositoryFile repositoryFile : files) {
	...
	void getUserLocale(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getSubFlowHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		logMsg(userInfo, "getSubFlowHash Not Implemented");
	}

	@RepositoryWebOp(code = RepositoryWebOpCodes.HASH_LIBRARY)
	void getLibraryHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getWebServiceHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getClassHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getIconsHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		RepositoryFile[] files = rep.listIcons(userInfo);
	...
	void getLibrariesHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		RepositoryFile[] files = rep.listLibraries(userInfo);
		String digest = CheckSum.digest(files);
		sendString(response, digest);
	...
	void getModifiedClassHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listFlowVersions(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void listSubFlowVersions(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getFlowVersionComment(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getSubFlowVersionComment(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		int pos = name.indexOf(';');
		String flowid = name.substring(pos + 1);
		int version = Integer.parseInt(name.substring(0, pos));
	...
	void getFlowVersion(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		int pos = name.indexOf(';');
		String flowid = name.substring(pos + 1);
		int version = Integer.parseInt(name.substring(0, pos));
	...
	void getSubFlowVersion(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		int pos = name.indexOf(';');
		String flowid = name.substring(pos + 1);
		int version = Integer.parseInt(name.substring(0, pos));
	...
	void setFlowVersioned(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		if (null == name || null == desc || null == buffer || buffer.length == 0)
			return; // sacana do editor
	...
	void setSubFlowVersioned(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		if (null == name || null == desc || null == buffer || buffer.length == 0)
			return; // sacana do editor
	...
	void listDataSources(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getConnectors(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void flowDocsGetFiles(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		String[] params = name.split(";", -1);
		String searchValue = params[0];
		String path = params[1];
		ContentResult content = DMSUtils.getInstance()
				.getDirectDescendents(DMSConnectorUtils.createCredential(userInfo), searchValue, path);
	...
	void listSignatureTypes(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getModifiedMessageHash(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void getTableDesc(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		String[] params = name.split(";", -1);
	...
	void undeployFlow(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
	...
	void runFlow(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name, String desc,
			byte[] buffer, String comment) throws Exception {
		if (StringUtils.isBlank(name))
			return;
		...
		ProcessData newProcData = processManagerBean.createProcess(userInfo,
				flowHolderBean.getFlow(userInfo, name).getId());
	...
	void setFlowReady2Run(UserInfoInterface userInfo, HttpServletResponse response, Repository rep, String name,
			String desc, byte[] buffer, String comment) throws Exception {
		if (StringUtils.isBlank(name))
			return;
