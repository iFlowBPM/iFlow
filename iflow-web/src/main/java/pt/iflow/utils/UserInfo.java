...
public class UserInfo
  implements Serializable, UserInfoInterface
{
...
UserInfo()
  ...
  private void login(String asLogin, String asPassword, String asSessionId, String asProfile, Boolean useWindowsDomainAuth, String token)
  {
    ...
    try
    {
      ...
      if (asProfile == null) {
        this.password = new PasswordGuardian(asPassword.getBytes(), this.loginTime);
      }
  ...
  public void loginSSO(String employeeid) {
	    ...
	    for(OrganizationViewInterface org: allOrg){
		    ...
		    for(UserData userData: allUserData)
		    	if((StringUtils.equalsIgnoreCase(userData.getUsername(), employeeid) || StringUtils.equalsIgnoreCase(userData.get("employeeid"), employeeid))&& StringUtils.equalsIgnoreCase(userData.get("activated"), "1")){
