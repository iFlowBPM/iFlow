...
public class RepositoryWebClient implements RepositoryClient {
  ...
  public RepositoryWebClient(String url, String login, String password, ClassLoader parent, FlowEditorConfig cfg, boolean offline) {
    ...
    if(null == cfg) cfg = new FlowEditorConfig();
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#login(java.lang.String, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#login(java.lang.String, java.lang.String, boolean)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#getProcessStateHistory(int, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#getProcessStateLog(int, java.lang.String, int)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#deployFlow(java.lang.String, java.lang.String, byte[])
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#deploySubFlow(java.lang.String, java.lang.String, byte[])
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#loadClass(java.lang.String, java.lang.String)
   */
  ...
  public boolean hasExtendedAPI() {
    if(null == extendedAPI) {
      ...
      if(null == str) str = "false"; //$NON-NLS-1$
  ...
  public Collection<FlowInfo> listFlowsExtended() {
    ...
    if(null != data && data.length > 0) {
      ...
      try {
        result = (Collection<FlowInfo>) unmarshaller.unmarshal(src);
      } catch (Exception e) {
        FlowEditor.log("error", e);
      }
      src = null;
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#getFlowVersionComment(java.lang.String, int)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#getSubFlowVersionComment(java.lang.String, int)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#deployFlowVersion(java.lang.String, java.lang.String, byte[], java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#deploySubFlowVersion(java.lang.String, java.lang.String, byte[], java.lang.String)
   */
  ...
  // Flow Docs
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#flowDocsGetFiles(java.lang.String, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see pt.iknow.iflow.RepositoryClient#setStatusListener(pt.iknow.iflow.RepositoryStatusListener)
   */
