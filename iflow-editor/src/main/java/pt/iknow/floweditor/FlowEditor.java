...
public class FlowEditor implements Runnable {
	...
	protected static void fireStatusChanged(boolean oldStatus, boolean newStatus) {
		if (null != statusChangedListener)
			statusChangedListener.statusChanged(oldStatus, newStatus);
	}
	...
	public static void main(String argv[]) {
		// Hard coded file encoding. Only works if this is the first class to be
		// called?
	...
	private static final class SWTRunner implements Runnable {
		...
		public void disposeSWT() {
			if (null == rootDisplay || rootShell == null)
				return;
