...
public class FormProps {
	...
	// FIXME: since creation of form props in api module, editor can use this
	// properties instead
	// of duplicating them... CHANGE EDITOR JSP FIELD DATA TO USE THEM.

	// attribute's name manipulation vars
	// (MUST match same vars in pt.iknow.uniflow.editor.blocks.JSPFieldData,
	// UniFlowEditor project)
	...
	// This block, allong with the arraytable object, is reponsible for setting
	// xml
	// tags named with this array value and "true" value, in order to allow xsl
	// designers
	// to process control tags accordingly, without the need for form block
	// changes
	...
	public final static String CHECKBOX_SUBMIT_ON_BLUR = "checkbox_submit_on_blur";
	...
	public final static String sDEF_CHECKED_VALUE = "1"; // check with datatypes
															// checkbox,radiobutton

	public final static String sOBLIGATORY_PROP = "obligatory_prop";

	public final static String sMAX_ROW = "_MAX_ROW"; // also used in
														// pt.iflow.blocks.form.ArrayTable
