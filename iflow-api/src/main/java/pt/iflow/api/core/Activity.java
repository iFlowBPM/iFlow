...
public class Activity {
	...
	public Activity(String u, String pu, int f, int p, int sp, int t, int pri, Timestamp s, Timestamp d, Timestamp a,
			String descr, String ur, int stat, int notif) {
		this();
		this.userid = u;
		this.previousUserid = pu;
		this.flowid = f;
	...
	public Activity(String u, int f, int p, int sp, int t, int pri, Timestamp s, Timestamp d, Timestamp a, String descr,
			String ur, int stat, int notif) {
		this();
		userid = u;
		flowid = f;
		pid = p;
	...
	public Activity(String u, String pu, int f, int p, int sp, int t, int pri, Timestamp s, Timestamp d, Timestamp a,
			String descr, String ur, int stat, int notif, String profName) {
		this();
		this.userid = u;
		this.previousUserid = pu;
		this.flowid = f;
	...
	public Activity(String u, int f, int p, int sp, int t, int pri, Timestamp s, Timestamp d, Timestamp a, String descr,
			String ur, int stat, int notif, String profName) {
		this();
		userid = u;
		flowid = f;
		pid = p;
