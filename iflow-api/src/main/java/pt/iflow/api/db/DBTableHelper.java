...
public class DBTableHelper {
  ...
  public static void addItem(DBTable dbTable, String name, String value, int pos) {
    ...
    // for MYSQL
    if ((StringUtils.equalsIgnoreCase(name, DBTable.FIELDMYSQL))) {
    	dbTable.setFields(addToList(dbTable.getFields(), DBTable.FIELD, value, pos));
    }else if (StringUtils.equalsIgnoreCase(name, DBTable.TYPEMYSQL)) {
        dbTable.setTypes(addToList(dbTable.getTypes(), DBTable.TYPE, value, pos));
    }else if (StringUtils.equalsIgnoreCase(name, DBTable.NULLMYSQL)) {
        dbTable.setNullables(addToList(dbTable.getNullables(),DBTable.NULL, value, pos));
    }else if (StringUtils.equalsIgnoreCase(name, DBTable.KEYMYSQL)) {
        dbTable.setKeys(addToList(dbTable.getKeys(), DBTable.KEY, value, pos));
    }else if (StringUtils.equalsIgnoreCase(name, DBTable.DEFAULTMYSQL)) {
        dbTable.setDefaults(addToList(dbTable.getDefaults(), DBTable.DEFAULT, value, pos));            
    //end MYSQL
        
    }else if (StringUtils.equalsIgnoreCase(name, DBTable.FIELD)) {
