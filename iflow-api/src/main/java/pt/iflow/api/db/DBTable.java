...
public class DBTable {
  ...
  //for MySQL
  public static final String FIELDMYSQL = "FIELD";
  public static final String TYPEMYSQL = "TYPE";
  public static final String NULLMYSQL = "NULL";
  public static final String KEYMYSQL = "KEY";
  public static final String DEFAULTMYSQL = "DEFAULT";
