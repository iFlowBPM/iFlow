...
/**
 * 
 * This class provides some utility methods for date and time manipulation
 * (timezone, etc)
 * 
 * @author oscar
 *
...
public class DateUtility {
	...
	// PGoncalves - 23082017 - Alteração do timestamp
	private static final String PROC_TIMESTAMP = "yyyy-MM-dd'&nbsp; <strong>['HH:mm'] </strong>'";
